...
export const AnimatedSpan = ({
  ...
  return (
    <motion.div
      ...
      className={cn("grid font-mono text-xs tracking-tight", className)}
      onAnimationComplete={() => {
        if (!sequence) return;
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 h-full w-full border border-white bg-black",
        className
      )}
    >
      <div className="flex flex-col gap-y-2 border-b border-white/20 p-4">
        <div className="flex flex-row gap-x-2">
          <div className="size-2 border border-white bg-white" />
          <div className="size-2 border border-white bg-white/50" />
          <div className="size-2 border border-white bg-transparent" />
        </div>
      </div>
      <pre className="p-4">
        <code className="grid gap-y-1 overflow-auto text-white">
          {wrappedChildren}
        </code>
      </pre>
    </div>
