  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-black">
      <DotPattern
        ...
        height={24}
        cr={1}
        className="pointer-events-none fixed inset-0 text-white/[0.12]"
      />

      <header className="relative z-10 flex items-center justify-between border-b border-white px-6 py-4">
        <span className="text-[11px] font-black uppercase tracking-[0.35em]">
          VAYNE
        </span>
        <Link
          href="/report"
          className="border border-white px-4 py-2 text-[10px] font-bold uppercase tracking-[0.15em] transition-colors hover:bg-white hover:text-black"
        >
          Report
        </Link>
      </header>
